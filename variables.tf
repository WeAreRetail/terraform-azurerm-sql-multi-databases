...
// Server naming / description / tags
...
variable "azuread_authentication_only" {
  type        = bool
  description = "(Optional) Whether to enforce Azure AD authentication only for SQL Server administrators. When true, SQL admin password cannot be used for authentication."
  default     = true
}
